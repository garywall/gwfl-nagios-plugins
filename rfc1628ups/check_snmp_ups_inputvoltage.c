/* $Id: check_snmp_ups_inputvoltage.c,v 1.2 2005/11/10 10:07:01 gary Exp $
 *
 * check_snmp_ups_inputvoltage.c -- check Input Voltage via SNMP
 *
...
#define PROGNAME "check_snmp_ups_inputvoltage"
#define SUMMARY "Check the Input Voltage on a UPS using SNMP."
...
char *inputtable = "1.3.6.1.2.1.33.1.3.3.1.3"; /* Input Voltage Table */
