/* $Id: check_snmp_temps_dl380g4.c,v 1.5 2005/11/10 09:50:48 gary Exp $
 *
 * check_snmp_temps_dl380g4.c -- check system temperatures via SNMP
 *
...
#define PROGNAME "check_snmp_temps_dl380g4"
#define SUMMARY "Check the system temperatures on a DL380 G4 using SNMP."
...
float thr[] = {62.0, 80.0, 60.0, 80.0, 50.0};
