/* $Id: check_snmp_temps_dl385g1.c,v 1.1 2005/11/18 05:52:35 gary Exp $
 *
 * check_snmp_temps_dl385g1.c -- check system temperatures via SNMP
 *
...
#define PROGNAME "check_snmp_temps_dl385g1"
#define SUMMARY "Check the system temperatures on a DL385 G1 using SNMP."
...
float thr[] = {100.0, 62.0, 100.0, 60.0, 51.0};
