/* $Id: check_snmp_temps_ml370g4.c,v 1.1 2006/05/25 10:03:38 gary Exp $
 *
 * check_snmp_temps_ml370g4.c -- check system temperatures via SNMP
 *
...
#define PROGNAME "check_snmp_temps_ml370g4"
#define SUMMARY "Check the system temperatures on a ML370 G4 using SNMP."
