/* $Id: check_snmp_temps_dl380g3.c,v 1.1 2006/05/25 10:03:38 gary Exp $
 *
 * check_snmp_temps_dl380g3.c -- check system temperatures via SNMP
 *
...
#define PROGNAME "check_snmp_temps_dl380g3"
#define SUMMARY "Check the system temperatures on a DL380 G3 using SNMP."
...
float thr[] = {62.0, 73.0, 68.0, 73.0, 53.0};
